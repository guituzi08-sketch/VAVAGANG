  ...
  return (
    <main className="app-shell">
      ...
      <section className="home-content">
        <div className="home-intro"><div><p className="eyebrow">Central de operações</p><h1>VAVAGANG <em>HUB</em></h1><p className="muted">Bom te ver novamente, {profile?.displayName?.split(" ")[0] ?? "jogador"}. Escolha seu próximo espaço.</p></div><div className="profile-chip"><Avatar profile={profile} large /><div><strong>{profile?.displayName}</strong><span>{profile?.email}</span></div></div><div className="home-arena" aria-hidden="true"><div className="arena-grid" /><div className="arena-ring arena-ring-back" /><div className="arena-ring arena-ring-front" /><div className="arena-core"><span>V</span></div><span className="arena-label arena-label-top">LIVE // HUB</span><span className="arena-label arena-label-side">SYSTEM READY</span></div></div>
