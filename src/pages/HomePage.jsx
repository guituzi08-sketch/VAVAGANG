  ...
  return (
    <main className="app-shell">
      ...
      <section className="home-content">
        <div className="home-intro"><div className="home-hero-copy"><p className="eyebrow">VAVAGANG // MAIN MENU</p><h1 className="home-wordmark">VAVA<br /><em>GANG</em></h1><p className="muted">Bom te ver novamente, {profile?.displayName?.split(" ")[0] ?? "jogador"}. Escolha seu próximo espaço.</p><div className="home-hero-meta"><span><b /> SECTOR 07</span><span><b /> VOICE MESH ONLINE</span><span>BUILD 2.0.26</span></div></div><div className="profile-chip"><Avatar profile={profile} large /><div><strong>{profile?.displayName}</strong><span>{profile?.email}</span></div></div><div className="home-arena" aria-hidden="true"><div className="arena-halo" /><div className="arena-ring arena-ring-back" /><div className="arena-ring arena-ring-front" /><div className="arena-ring arena-ring-inner" /><div className="arena-sigil"><i /><i /><i /><i /><span>V</span></div><span className="arena-label arena-label-top">VAVAGANG // LIVE</span><span className="arena-label arena-label-side">SYSTEM READY</span><span className="arena-label arena-label-bottom">NO SIGNAL // NO LIMITS</span></div></div>
